        ...
        <div class="row align-items-center py-3 px-xl-5">
            ...
            <div class="col-lg-3 col-6 text-right">
                <a href="" class="btn border">
                    ...
                    <span id="userFavourites" class="badge">{{ App\Models\Favourite::where('user_id', 1)->count() }}</span>
                </a>
                <a href="" class="btn border">
                    <i class="fas fa-shopping-cart text-primary"></i>
                    <span id="userCart" class="badge">{{ App\Models\Cart::where('user_id', 1)->sum('quantity') }}</span>
                </a>
            </div>
        </div>
    </div>
                ...
                <nav class="collapse position-absolute navbar navbar-vertical navbar-light align-items-start p-0 border border-top-0 border-bottom-0 bg-light" id="navbar-vertical" style="width: calc(100% - 30px); z-index: 1;">
                    <div class="navbar-nav w-100 overflow-hidden" style="height: 410px">
                        @foreach (App\Models\Category::all() as $category)
                            <a href="" class="nav-item nav-link text-capitalize">{{ $category->name }}</a>
                        @endforeach>
                    </div>
                </nav>
            </div>
                ...
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="{{ url('books') }}" class="nav-item nav-link">Shop</a>
        ...
        <div class="row border-top border-light mx-xl-5 py-4">
            <div class="col-md-6 px-xl-0">
                <p class="mb-md-0 text-center text-md-left text-dark">
                    &copy; <a class="text-dark font-weight-semi-bold" href="#">mesob.library.com</a>. All Rights Reserved.


                </p>
            </div>
            <div class="col-md-6 px-xl-0 text-center text-md-right">
                <img class="img-fluid" src="{{ asset('front_end/img/payments.png') }}" alt="">
            </div>
        </div>
    </div>
    <!-- Footer End -->
